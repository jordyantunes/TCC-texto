...
\include{configuracoes/comandos}
\include{configuracoes/configuracoes-pdf}
\newcommand{\verificar}[1]{\textbf{\textcolor{red}{#1}}}
...
\includepdf[pages=-]{termo_aprovacao.pdf}
...
\include{estrutura/pre-textuais/listas}          		   % Lista de Abreviaturas e Siglas
...
\include{estrutura/textuais/introducao2}                		           % Introdução
\include{estrutura/textuais/desenvolvimento/revisao-de-literatura}         % Revisão de Literatura
% \include{estrutura/textuais/desenvolvimento/algoritmos} %include realizado na revisao da literatura
\include{estrutura/textuais/desenvolvimento/metodologia}               % Metodologia
\include{estrutura/textuais/desenvolvimento/resultados}

% \include{estrutura/textuais/desenvolvimento/sceneframe}                   % Scene Frame
