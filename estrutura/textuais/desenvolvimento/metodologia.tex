...
\begin{tabular}{|p{0.2\textwidth}|p{0.4\textwidth}|p{0.4\textwidth}|} \hline
    ...
    SMALL & dimensionamento da Altura e Largura dos Vídeos para Menor & \begin{tabular}{@{}l@{}} Fator de redimensionamento: 2\\ MANTÉM aspect ratio: sim \end{tabular} \\ \hline
