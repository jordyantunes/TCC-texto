...
\begin{table}[h]
    ...
    \end{tabular}
    \fonte{\cite{hua2004robust}, \cite{lee2008robust}, \cite{cook2011efficient}, \cite{mao2015sceneframe}, \cite{kim2014rotation}, \cite{Dutta2013}, \cite{minetto2007reliable}.}
\end{table}
