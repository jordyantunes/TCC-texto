...
\begin{figure}[h]
  ...
  \includegraphics[width=0.5\textwidth]{dados/figuras/filtro_passa_baixa}
\end{figure}
...
\begin{figure}[h]
  ...
  \includegraphics[width=0.5\textwidth]{dados/figuras/dy}
\end{figure}
