...
\begin{figure}[h]
	...
	\includegraphics[width=0.8\textwidth]{dados/figuras/experimentos/histograma_Medida Ordinal.png}
\end{figure}
\begin{figure}[h]
	\centering
	\label{fig:limiares-sceneframe}
	\caption{Teste de limiares para a assinatura sceneframe}
	\includegraphics[width=0.8\textwidth]{dados/figuras/experimentos/histograma_Scene Frame.png}
\end{figure}
\begin{figure}[h]
	\centering
