...
\begin{figure}[h]
  ...
  \begin{tabular}{ccc}
  	\centering
    \includegraphics[width=0.45\textwidth]{images/ww.jpg} & \includegraphics[width=0.45\textwidth]{images/ww_bw.jpg} \\ 
     a. Quadro original & b. Quadro em escala de cinza \\
    \multicolumn{2}{c}{\includegraphics[width=0.94\textwidth]{images/ww_haar_.jpg}} \\
...
%   \includegraphics[width=0.8\textwidth]{images/haar.png}
