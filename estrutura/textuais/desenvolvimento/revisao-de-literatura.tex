...
\subsection{Assinatura baseada em quadros de cena}
  ...
  A abordagem proposta por \citeonline{mao2015sceneframe} é baseada na assinatura de quadros de cena (Seção \ref{sec:video}). De acordo com os autores, os quadros de cena podem ser intraframes, ou seja, quadros que iniciam tomadas, quanto interframes, contanto que sigam as características descritas na Seção \ref{sec:video}, ou seja, possuir todos os mesmos elementos dos quadros restantes e o mesmo \textit{background}.
...
%trabalha com keyframes para cada cena do vídeo
...
Esse algoritmo proposto por \citeonline{minetto2007reliable}
